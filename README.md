...
Cette bibliothèque C++ permet de communiquer directement avec une imprimante Zebra via USB en utilisant l'API Windows `SetupAPI`. Elle inclut un pont **JNI** pour une utilisation fluide avec Java.
...
- **Zéro Driver** : Pas besoin de spooler Windows, communique directement avec l'ID matériel USB.
